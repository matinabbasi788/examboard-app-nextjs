...
export function TermsList() {
  ...
  async function handleDelete(id: number) {
    ...
    try {
      ...
      setError('نمی توان ترم رو حذف کرد. ترم دارای موجودیت امتحان میباشد.(ترم باید خالی باشد)');
      console.error(err);
    }
  }
      ...
      <form onSubmit={handleSubmit} className="mb-8 space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <input
            ...
            placeholder="نام (به عنوان مثال: پاییز ۱۴۰۳)"
          ...
          <JalaliDatePicker
            ...
            disabled={adding}
            placeholder="تاریخ شروع (Jalali YYYY/MM/DD)"
          />
          ...
          <JalaliDatePicker
            ...
            disabled={adding}
            placeholder="تاریخ پایان (Jalali YYYY/MM/DD)"
          />
          <input
            type="text"
            value={newTermCode}
            onChange={(e) => setNewTermCode(e.target.value)}
            placeholder="کد (به عنوان مثال: 1403-FA)"
